...
public:
	...
	// DAC
	void setMaxCurrent(float max_amps); // [Amps] set based on motor current corresponding to max DAC output
...
private:
	...
	// DAC
	float maxCurrent_ = 1.0; // [Amps] maximum motor current, PID will assumes this corresponds to max DAC value
